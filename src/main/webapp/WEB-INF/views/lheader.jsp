...
#nprogress .bar{background:#2299DD;position:fixed;z-index:1031;top:0;left:0;width:100%;height:2px;}
#nprogress .peg{display:block;position:absolute;right:0px;width:100px;height:100%;box-shadow:0 0 10px #2299DD,0 0 5px #2299DD;opacity:1;-webkit-transform:rotate(3deg) translate(0px,-4px);-ms-transform:rotate(3deg) translate(0px,-4px);-webkit-transform:rotate(3deg) translate(0px,-4px);-ms-transform:rotate(3deg) translate(0px,-4px);transform:rotate(3deg) translate(0px,-4px);}
	...
	<section class="header_top">
		<div class="header_logo header_logo_s">
			<div class="log_box"
				...
				<a href="/"><img src="/resources/img/555.png" class="logo"
					alt="헬로마켓"><img src="resources/img/555.png"
			...
			<div class="btn_box">
				<div class="nick">
					<img
						...
						width="36" height="36" alt="n16132188의 프로필 사진" class="profile_img"><span
						class="nick_title">n16132188님</span>
				</div>
				<div class="notification_box">
					<a href="https://account.hellomarket.com/messages" target="_blank"
						rel="noopener noreferrer"><img
						src="https://ccimage.hellomarket.com/web/2019/common/btn_title_hellotalk.png"
						alt="채팅 아이콘" class="chat"></a><a
						...
						alt="알림목록 아이콘" class="alram"></a>
				</div>
			</div>
			<div>
				<div class="gnb_my_lyr test_type ">
					<a href="/m/level.hm"><div class="gnb_my_member_level">
					...
					<ul class="gnb_my_list" >
						<a href="/user/myshop"><li class="gnb_my_list_first">내상점</li></a>
						<a href="/m/hellopay.hm?type=seller&amp;status=open"><li>헬로페이
								거래내역</li></a>
						<a href="/m/wallet/history"><li>전자지갑 · 결제관리</li></a>
						<a href="/m/coupon"><li>할인쿠폰</li></a>
						<a href="/m/order/auto/sales/list.hm"><li>일반 결제내역</li></a>
						<a href="/m/shipping.hm?type=sender"><li>배송관리</li></a>
		...
		<div class="header_wrapper">
			...
			<div class="link_box header_wrapper_sub">
				<ul>
					...
					<li><a href="/help/faq.hm">お問い合わせ</a></li>
