				...
				<div class="main">
					...
					<section class="left_main profile_right_main" >
						<div class="tab_content">
							<div class="my_profile_item_menu" style="margin-bottom: 100px;">
								<ul>
									<li class=""><a class="" href="/user/myshop">販売商品</a></li>
									<li class="active"><a class="active" href="/user/hidenshop">隠し商品</a></li>
									<li class=""><a class="" href="/user/selected">お気に入り</a></li>
								</ul>
							</div>
							<div class="cat_box">
								<div class="hidden_title">非表示商品は会員様のみご覧いただけます。 ステータスを販売中に変更すると非表示が解除されます。</div>
							</div>
							<div class="tab_content">
								<div class="default_message">
									<div>
										<span class="txt_color_n">隠し商品はございません。<br></span>
									</div>
								</div>
							</div>
						</div>
