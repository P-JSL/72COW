		...
		<div class="left">
			<div class="category_filter">
				<div class="category_title">
					<div class="category_title_txt">食品</div>
				</div>
			</div>
		...
		<section class="left_main">
			...
			<div class="tab_area biz_area item_tab_area">
				<div class="tab_type_box">
					<a href="/search?category=HAU0000&amp;page=1&amp;isEscrowOnly=true"><div
					...
					<div class="tab_type biz_type mobile_type">
						<ul>
							<a href="/search?category=HAU0000&amp;tabType=list&amp;page=1"><li
								class="list"></li></a>
							<a
								href="/search?category=HAU0000&amp;tabType=thumbnail&amp;page=1"><li
