			...
			<div class="tab_con" id="tab_con">
				...
				<div id="tab-1" class="tab-content current">
					<div class="mail_view">
						...
						<h2>일반문의 신청 페이지</h2>
						<form method="get" action="/yeeun/noticeInsert">
							<table class="inquiry_table">
								<tbody>
									<tr>
										<td class="label">*タイトル</td>
										<td class="field" style="height: 80px;">
										<input type="text" class="" placeholder="タイトルを入力してください" value=""
											style="margin-top: 22px;" name="title"></td>
									</tr>
									<tr>
										<td class="field photo_field" colspan="2"><textarea
												placeholder="内容を入力" class="textarea" rows="7" name="content"></textarea></td>
									</tr>
								</tbody>
							</table>
