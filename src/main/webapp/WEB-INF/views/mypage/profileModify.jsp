			...
			<div class="page_aticle">
				...
				<div class="type_form member_join ">
					<form id="form" name="frmMember" method="post"
						action="/mypage/profileModify" onsubmit="return chkForm2(this)"
						novalidate="" style="position: relative; top: 150px;">
						...
						<table class="tbl_comm">
							<tbody>
								<tr class="fst">
									<th>ID(変更不可能)<span class="ico">*<span
											class="screen_out"></span></span></th>
									<td><input type="text" name="userid"
										value="${userlist.userid }" maxlength="16" required=""
										fld_esssential="" option="regId" label="ID"
										placeholder="${userlist.userid}" readonly="readonly">
										<p class="txt_guide square">
											<span class="txt txt_case1">6자 이상의 영문
												혹은 영문과 숫자를 조합</span> <span
								...
								<tr>
									...
									<td><input type="password" name="password"
										label="パスワード" maxlength="16" class="reg_pw"
										placeholder="パスワードを入力してください。">
										<p class="txt_guide square">
											<span class="txt txt_case1">10자 이상 입력</span> <span
												class="txt txt_case2">영문/숫자/특수문자(공백
												제외)만 허용하며, 2개 이상 조합</span> <span
												class="txt txt_case3">동일한 숫자 3개 이상
												연속 사용 불가</span>
										</p></td>
								</tr>
								<tr>
									<th>名前<span class="ico">*<span
											class="screen_out">필수항목</span></span></th>
									<td><input style="width: 150px" type="text" name="f_name"
										fld_esssential="" label="성" placeholder="${userlist.f_name}"
										value="${userlist.f_name}"> <input
										style="width: 150px; position: relative; left: 27px;"
										; type="text" name="l_name" value="${userlist.l_name}"
										required="" fld_esssential="" label="이름"
										placeholder="${userlist.l_name}"></td>
								...
								<tr>
									...
									<td><input style="width: 150px" type="text"
										value="${userlist.f_e_name}" name="f_e_name" fld_esssential=""
										label="성" placeholder="${userlist.f_e_name}"> <input
										style="width: 150px; position: relative; left: 27px;"
										; type="text" name="l_e_name" value="${userlist.l_e_name}"
										required="" fld_esssential="" label="이름"
										placeholder="${userlist.l_e_name}"></td>


								</tr>
								<tr>
									<th>メール<span class="ico">*<span
											class="screen_out">필수항목</span></span></th>
									<td><input type="text" name="email"
										value="${userlist.email}" data-email="" size="30" required=""
										fld_esssential="" option="regEmail" label="이메일"
										placeholder="${userlist.email}"></td>
								</tr>
								<tr class="field_phone">
									<th>電話番号<span class="ico">*<span
											class="screen_out">필수항목</span></span></th>
									<td>
										<div class="phone_num">
											<input type="text" value="${userlist.phone}" pattern="[0-9]*"
												name="phone" placeholder="${userlist.phone}" class="inp">
										</div>
									</td>
								</tr>
								<tr>
									<th>住所<span class="ico">*<span
											class="screen_out">필수항목</span></span></th>
